 ...
 ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-xl-4 col-md-6 mb-4">
              <div class="card border-left-<?php if($user['role'] == 'role_admin'){ echo 'danger'; } else {echo 'primary';} ?> shadow h-100 py-2">
                  <div class="card-body">
                      <div class="row no-gutters align-items-center">
                          <div class="col mr-2">
                              <div class="text-xs font-weight-bold text-<?php if($user['role'] == 'role_admin'){ echo 'danger'; } else {echo 'primary';} ?> text-uppercase mb-1">
                                  Role</div>
                              <div class="h5 mb-0 font-weight-bold text-gray-800"><?php if($user['role'] == 'role_admin'){ echo 'Administrateur'; } else {echo 'Utilisateur';} ?></div>
                          </div>
                          <div class="col-auto">
                              <i class="fas fa-<?php if($user['role'] == 'role_admin'){ echo 'user-cog'; } else {echo 'user';} ?> fa-2x text-gray-300"></i>
                          </div>
                      </div>
                  </div>
              </div>
